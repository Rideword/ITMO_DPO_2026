...
| ПР5 | Roofline-анализ: определение compute-bound и memory-bound операций | Практика | 4 | HPC-1 | HPC-1.1, HPC-1.2 | Продвинутый |
| ПР6 | Расчёт архитектуры LLM: VRAM, пропускная способность, квантизация и перплексия | Практика | 4 | HPC-1 | HPC-1.1, HPC-1.2 | Продвинутый |
