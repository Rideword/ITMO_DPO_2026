...
Для практической работы по расчёту архитектуры LLM рекомендуется подготовить «Краткий реестр архитектурных рисков» (риск, вероятность, влияние, мера контроля, остаточный риск). Данный артефакт не требует дополнительных баллов.
