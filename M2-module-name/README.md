...
| ЛР3 | Настройка ML-окружения: CUDA, nvidia-container-toolkit, верификация | Практика | 4 | LC-5 | LC-5.1 | Базовый |
| ЛР4 | Docker для ML: multi-stage образ, Docker Compose (модель+API+мониторинг) | Практика | 4 | LC-5 | LC-5.1 | Базовый |
...
| КТ 4 | Отчёт | Отчёт по ЛР 3–4 (ML-окружение, Docker) | 20 |
